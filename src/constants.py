...
CORE_PARAMS = [
    ...
    ('Total Assets','totalAssets','balancesheet','Total assets in the company'),
    ('Total Debt','totalDebt','balancesheet','Total debt in the company'),
    ...
    ('RoE', 'returnOnEquity', 'ratios', 'Return on Equity: good to compare against other of the same peer group.'),
    ...
    ('PEG', 'priceEarningsToGrowthRatio', 'ratios', 'Price earnings to growth ratio. We want this value low'),
]
PROFILE_PARAMS = [
    ('Symbol', 'symbol'),
    ('Price', 'price'),
...
COMPARE_PROFILE_PARAMS = [
    ('Symbol', 'symbol'),
    ('Price', 'price'),
    ('Current MC', 'marketCap'),
    ('Beta', 'beta'),
]
...
#   Style
STYLE_PARAM = Font(bold=True, color='000000')
